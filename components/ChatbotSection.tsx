...
const ChatbotSection: React.FC = () => (
  <section id="ai-chatbot" style={{ padding: '80px 0', borderBottom: '1px solid #e8eeff', background: '#f8f9ff' }}>
    <div className="container">
      ...
      {/* iPad 13" Landscape — no home button, Face ID notch only */}
      <div style={{
        maxWidth: 1100,
        margin: '0 auto',
        position: 'relative',
        ...
        <div style={{
          ...
          {/* Left side bar (power/volume buttons as thin ridge) */}
          ...
          {/* Top bar with Face ID */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 14, marginBottom: 6 }}>
            <div style={{ width: 80, height: 4, background: '#111', borderRadius: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#222', border: '1px solid #333' }} />
            </div>
          </div>
          ...
          {/* Bottom bar — no home button, just thin ridge */}
